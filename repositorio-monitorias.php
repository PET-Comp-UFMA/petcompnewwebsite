    ...
    <div class="rep-wrap">
        ...
        <div class="rep-sem-section">
            ...
            <div class="rep-sem-pills">
                ...
                foreach ($exibir as $sem):
                    $url = '?monitoria=' . urlencode($monitoria['id'])
                ...
                <a href="?monitoria=<?= urlencode($monitoria['id']) ?>&semestre=<?= urlencode($semestre_ativo) ?>&todos_semestres=1"
                   class="rep-ver-mais">
                    Ver mais
        ...
        <div class="rep-grid-container">
            <div class="rep-grid">
                ...
                <div class="rep-empty">
                    <svg viewBox="0 0 24 24"><path d="M3 22V2l18 10L3 22z"/></svg>
                ...
                <div>
                    ...
                    <div class="rep-lista">
                        <?php foreach ($aulas_semestre as $i => $aula):
                            $yt    = $aula['youtube_id'];
                            $ativo = ($i === $aula_idx);
                            $url_item = '?monitoria=' . urlencode($monitoria['id'])
