...
<body>
    ...
    <div class="group">
        <div class="image-container">
            <img src="img/monitoria-photo-5.png" class="wide">
        </div>
        <div class="image-container">
            <img src="img/monitoria-photo-6.png">
        </div>
    </div>
    <div class="group">
        <div class="image-container">
            <img src="img/monitoria-photo-4.jpg" class="wide">
        </div>
        <div class="image-container">
            <img src="img/monitoria-photo-1.jpg">
        </div>
    </div>
</div>
