...
<body>
    ...
    <div class="painel-declaracao" data-painel="emissao">
        ...
        <div id="resultado-erro" class="resultado-erro hidden"></div>
        <div class="card-form">
            <form action="" id="form-emissao">
                ...
                <button id="btnverificar" class="btnRegistrar" type="submit">
    ...
    <div class="painel-declaracao" data-painel="validacao">
        ...
        <div id="validacao-erro" class="validacao-erro hidden"></div>
        ...
        <div class="card-form">
            <form action="" id="form-validacao">
                ...
                <button id="btnvalidar" class="btnRegistrar" type="submit">
                    Verificar
                </button>
            </form>
        </div>
    ...
    <!-- CARD ÚNICO: compartilhado por emissão e validação -->
    <div id="declaracao-card" class="declaracao-card hidden" >

        <div id="declaracao-status" class="status-declaracao">
            Declaração disponível!
        </div>

        <div class="corpo-declaracao">
            <div class="cabecalho-declaracao">
                <div class="logo-declaracao">
                    <img src="img/LOGO CLARA.svg" alt="">
                    <p>
                        PET<br>
                        <strong>COMP</strong>
                    </p>
                ...
                <div class="info-aluno">
                    <span>DECLARAÇÃO DE HORAS COMPLEMENTARES</span>
                    <strong id="declaracao-nome">
                        Nome Completo
                    </strong>
                </div>
            </div>
            <div class="informacoes-declaracao">
                <div class="periodo">
                    <span>PERÍODO</span>
                    <strong>
                        Início:
                        <span id="declaracao-entrada">
                            dd/mm/aa
                        </span>
                    </strong>
                    <strong>
                        término:
                        <span id="declaracao-saida">
                            dd/mm/aa
                        </span>
                    </strong>
                </div>
        ...
        <button id="btn-baixar-declaracao" type="button">
            Baixar Declaração
        </button>
    </div>
