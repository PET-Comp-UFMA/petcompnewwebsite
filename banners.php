                    ...
                    <div class="swiper info-carousel">
                        <div class="swiper-wrapper">
                            ...
                            <div class="banner-card">
                                ...
                                <p>O acompanhamento de resultados em projetos educacionais é essencial para garantir transparência e qualidade, mas dados estáticos dificultam a análise. Nesse contexto, dashboards interativos facilitam a visualização e a tomada de decisões. Este artigo apresenta o desenvolvimento de um dashboard para projetos de pesquisa educacional, incluindo uma planilha automatizada, o sistema do painel e sua validação com o cliente, utilizando dados fictícios e com possibilidade de adaptação futura.</p>
