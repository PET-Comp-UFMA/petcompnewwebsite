         ...
         <?php if (count($integrantes) > 0 || count($orientadoresAtivos) > 0): ?>
            <div class="integrantes">
               <div class="orientadores">
                  <?php foreach ($orientadoresAtivos as $orientador): echo geraCard($orientador, "Orientador", "chalkboard-teacher");
                  endforeach; ?>
               </div>
               <div class="discentes">
                  <?php foreach ($integrantes as $integrante): echo geraCard($integrante, "Orientando", "user-graduate");
                  endforeach; ?>
               </div>
               <?php if (count($voluntarios) > 0): ?>
                  ...
                  <div class="integrantes voluntarios">
                     <div class="discentes">
                        <?php foreach ($voluntarios as $voluntario): echo geraCard($voluntario, "Voluntário", "user-graduate");
                        endforeach; ?>
                     </div>
                  </div>
               <?php endif; ?>
      ...
      <?php else: ?>
         <?php if (count($inativos) > 0): ?>
            ...
            <div class="integrantes ex">
               <div class="orientadores">
                  <?php foreach ($orientadoresInativos as $orientador): echo geraCard($orientador, "Orientador", "chalkboard-teacher");
                  endforeach; ?>
               </div>
               <div class="discentes ex">
                  <?php foreach ($inativos as $inativo): echo geraCard($inativo, "Orientando", "user-graduate");
                  endforeach; ?>
               </div>
            </div>
         <?php endif; ?>
